...
import { TypeOrmRepository } from './../../../../Shared/infrasestructure/persistence/typeorm/TypeOrmRepository';
...
export class TypeOrmCourseRepository extends TypeOrmRepository<Course> implements CourseRepository {
  ...
  public async search(id: CourseId): Promise<Nullable<Course> | undefined> {
